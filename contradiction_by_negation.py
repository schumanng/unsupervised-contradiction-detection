...
What you need to do: install required packages and change the path according to your directory (line 182)
"""
...
negation_insertion_df.to_csv('output/contradiction_by_negation.csv', sep=';')
